...
Putting forward a while loop which takes the argument of  time, the user wants to set the alarm on and automatically breaks when the time is up, with sound
